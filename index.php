...
<head>
    ...
    <div>
        ...
        <p>Nombre</p>
        <input type="text" id="nombre" name="nombre" required minlength="4" maxlength="100" size="50" placeholder="Ingrese su nombre">
        <br>

        <p>Apellido</p>
        <input type="text" id="apellido" name="apellido" required minlength="4" maxlength="100" size="50" placeholder="Ingrese su Apellido">
        <br>

        <p>Edad</p>
        <input type="number" id="edad" name="edad" required minlength="1" maxlength="3" size="60" placeholder="Ingrese por favor su edad">
        <br>

        <p>Telefono</p>
        <input type="number" id="tel" name="tel" required minlength="8" maxlength="15" size="60" placeholder="Ingrese por favor un telefono">
        <br>
